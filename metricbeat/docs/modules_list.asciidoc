...
.22+| .22+|  |<<metricbeat-metricset-system-chrome_extension,chrome_extension>> beta[]  
...
|<<metricbeat-metricset-system-hardware,hardware>> beta[]  
|<<metricbeat-metricset-system-load,load>>   
|<<metricbeat-metricset-system-manictime,manictime>> beta[]  
...
|<<metricbeat-metricset-system-software,software>> beta[]  
