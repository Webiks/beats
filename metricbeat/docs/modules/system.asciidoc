...
* <<metricbeat-metricset-system-chrome_extension,chrome_extension>>
...
* <<metricbeat-metricset-system-hardware,hardware>>

* <<metricbeat-metricset-system-load,load>>

* <<metricbeat-metricset-system-manictime,manictime>>
...
* <<metricbeat-metricset-system-software,software>>

* <<metricbeat-metricset-system-uptime,uptime>>

* <<metricbeat-metricset-system-users,users>>

include::system/chrome_extension.asciidoc[]
...
include::system/hardware.asciidoc[]

include::system/load.asciidoc[]

include::system/manictime.asciidoc[]
...
include::system/software.asciidoc[]
